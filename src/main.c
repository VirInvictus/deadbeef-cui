...
int cui_start(void) {
    ...
    gtkui_plugin->w_reg_widget("Facet Browser (CUI) v1.3.1", DDB_WF_SUPPORTS_EXTENDED_API, cui_create_widget, "cui", NULL);
    fprintf(stderr, "deadbeef-cui: Facet Browser v1.3.1 registered successfully.\n");
...
static DB_misc_t plugin = {
    ...
    .plugin.descr = "A faceted library browser for DeaDBeeF. Version 1.3.1",
